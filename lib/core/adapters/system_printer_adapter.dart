...
class SystemPrinterAdapter implements PrinterAdapter {
  ...
  Future<PrinterAdapterResult> print(
    ...
    try {
      final printed = await Printing.directPrintPdf(
        ...
        name: 'Receipt ${document.localInvoiceNo}',
        format: _renderer.pageFormatForWidth(profile.paperWidthMm),
  ...
  Future<Printer?> _configuredPrinter(PrinterProfile profile) async {
    ...
    for (final printer in printers) {
      ...
      if (configuredUrl != null && printer.url == configuredUrl) return printer;
